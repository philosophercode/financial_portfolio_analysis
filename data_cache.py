...
class DataCache:
    ...
    def get_cached_data(self, symbol: str, period: str, source: str = "yahoo") -> Optional[pd.DataFrame]:
        """
    ...
    def cache_data(self, symbol: str, period: str, data: pd.DataFrame, source: str = "yahoo") -> None:
        """
